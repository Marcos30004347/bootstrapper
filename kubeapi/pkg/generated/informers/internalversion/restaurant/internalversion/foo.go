...
import (
	...
	clientsetinternalversion "github.com/marcos30004347/kubeapi/pkg/generated/clientset/internalversion"
	internalinterfaces "github.com/marcos30004347/kubeapi/pkg/generated/informers/internalversion/internalinterfaces"
	internalversion "github.com/marcos30004347/kubeapi/pkg/generated/listers/restaurant/internalversion"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.Restaurant().Foos(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.Restaurant().Foos(namespace).Watch(context.TODO(), options)
			},
		},
		&restaurant.Foo{},
		resyncPeriod,
...
func (f *fooInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&restaurant.Foo{}, f.defaultInformer)
}
