...
import (
	...
	restaurantv1alpha1 "github.com/marcos30004347/kubeapi/pkg/apis/restaurant/v1alpha1"
	versioned "github.com/marcos30004347/kubeapi/pkg/generated/clientset/versioned"
	internalinterfaces "github.com/marcos30004347/kubeapi/pkg/generated/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/marcos30004347/kubeapi/pkg/generated/listers/restaurant/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.RestaurantV1alpha1().Foos(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.RestaurantV1alpha1().Foos(namespace).Watch(context.TODO(), options)
			},
		},
		&restaurantv1alpha1.Foo{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *fooInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&restaurantv1alpha1.Foo{}, f.defaultInformer)
}
