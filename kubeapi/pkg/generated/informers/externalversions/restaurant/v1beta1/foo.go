...
import (
	...
	restaurantv1beta1 "github.com/marcos30004347/kubeapi/pkg/apis/restaurant/v1beta1"
	...
	v1beta1 "github.com/marcos30004347/kubeapi/pkg/generated/listers/restaurant/v1beta1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.RestaurantV1beta1().Foos(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.RestaurantV1beta1().Foos(namespace).Watch(context.TODO(), options)
			},
		},
		&restaurantv1beta1.Foo{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *fooInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&restaurantv1beta1.Foo{}, f.defaultInformer)
}
