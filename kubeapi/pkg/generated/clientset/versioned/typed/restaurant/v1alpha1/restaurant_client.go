...
import (
	...
	"github.com/marcos30004347/kubeapi/pkg/generated/clientset/versioned/scheme"
...
func (c *RestaurantV1alpha1Client) Bars() BarInterface {
	return newBars(c)
}

func (c *RestaurantV1alpha1Client) Foos(namespace string) FooInterface {
