...
import (
	...
	v1alpha1 "github.com/marcos30004347/kubeapi/pkg/apis/restaurant/v1alpha1"
...
func newBars(c *RestaurantV1alpha1Client) *bars {
	return &bars{
		client: c.RESTClient(),
	}
}
...
func (c *bars) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Bar, err error) {
	result = &v1alpha1.Bar{}
	err = c.client.Get().
		Resource("bars").
		Name(name).
...
func (c *bars) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.BarList, err error) {
...
func (c *bars) Create(ctx context.Context, bar *v1alpha1.Bar, opts v1.CreateOptions) (result *v1alpha1.Bar, err error) {
	result = &v1alpha1.Bar{}
	err = c.client.Post().
		Resource("bars").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *bars) Update(ctx context.Context, bar *v1alpha1.Bar, opts v1.UpdateOptions) (result *v1alpha1.Bar, err error) {
	result = &v1alpha1.Bar{}
	err = c.client.Put().
		Resource("bars").
		Name(bar.Name).
...
func (c *bars) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Bar, err error) {
	result = &v1alpha1.Bar{}
