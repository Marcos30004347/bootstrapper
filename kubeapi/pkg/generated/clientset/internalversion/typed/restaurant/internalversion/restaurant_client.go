...
import (
	"github.com/marcos30004347/kubeapi/pkg/generated/clientset/internalversion/scheme"
...
func (c *RestaurantClient) Bars() BarInterface {
	return newBars(c)
}

func (c *RestaurantClient) Foos(namespace string) FooInterface {
